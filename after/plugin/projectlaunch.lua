...
projectlaunch.add_custom_command("cp ../.env-culture ./backend-services/apps/culture-service/.env")
projectlaunch.add_custom_command("cp ../.env-user ./backend-services/apps/user-service/.env")
