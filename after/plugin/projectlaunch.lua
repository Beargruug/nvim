...
projectlaunch.add_custom_command("cp ../.env-culture ./backend-services/culture-service/.env")
projectlaunch.add_custom_command("cp ../.env-user ./backend-services/user-service/.env")
projectlaunch.add_custom_command("cp ../.env-gateway ./backend-services/gateway/.env")
