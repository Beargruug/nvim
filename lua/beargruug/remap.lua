...
vim.keymap.set("n", "sf", ":Explore<CR>")
vim.keymap.set("n", "<leader>sf", ":NvimTreeFindFileToggle<CR>")
...
vim.keymarp.set("n", "<leader>dv", "<cmd>:DiffViewOpen<CR>")
vim.keymarp.set("n", "<leader>dc", "<cmd>:DiffViewClose<CR>")
